---
intent: reference-clustertemplate-vsphere-format
audience: platform-engineers
prereqs: k0rdent-management-cluster-with-template-crds
inputs: vsphere-specific-infrastructure-parameters-and-template-selection
outputs: valid-vsphere-clustertemplate-parameter-understanding-for-clusterdeployment-authoring
...
metadata:
  name: cluster-1
spec:
  template: vsphere-standalone-cp-1-8-0
