---
intent: reference-clustertemplate-aws-format
audience: platform-engineers
prereqs: k0rdent-management-cluster-with-template-crds
inputs: aws-specific-infrastructure-parameters-and-template-selection
outputs: valid-aws-clustertemplate-parameter-understanding-for-clusterdeployment-authoring
related_docs: docs/reference/template/index.md, docs/reference/crds/index.md, docs/quickstarts/quickstart-2-aws.md, docs/user/user-create-cluster.md
...
| Template | Section(s) |
| --- | --- |
| `aws-standalone-cp-1-8-0` | `.spec.controlPlane.nonRootVolumes`,`.spec.worker.nonRootVolumes` |
| `aws-hosted-cp-1-8-0` | `.spec.nonRootVolumes` |
| `aws-eks-1-8-0` | `.spec.worker.nonRootVolumes` |
