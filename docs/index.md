---
intent: understand-k0rdent-platform
audience: platform-engineers
prereqs: basic-kubernetes-knowledge
inputs: deployment-goals-and-environment-scope
outputs: navigation-to-install-admin-user-and-reference-docs
related_docs: concepts/index.md, admin/index.md, user/index.md, quickstarts/index.md
last_verified_version: 1.8.0
---

# Welcome to the k0rdent documentation
## Introductions
