...
k0rdent enables deployment of hosted control plane clusters with the API server and konnectivity
...
In k0rdent, ingress support is enabled in the default `openstack-hosted-cp` `ClusterTemplate`. 
