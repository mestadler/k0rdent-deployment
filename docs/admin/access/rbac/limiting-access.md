...
While you could certainly run k0rdent with all of your people
...
Fortunately, k0rdent makes it possible to avoid this situation. 
...
In order for k0rdent to manage infrastructure, you must provide it
...
The `kcm-system` namespace should be reserved for core components that come with k0rdent
...
For more information on the `ClusterRoles` available in k0rdent
