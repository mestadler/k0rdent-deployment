...
objects (with `spec.region`) and for the `Credential` distributed by the k0rdent
...
with its own reference-resolution instructions. Providers included with k0rdent already
