...
4. Create the `ClusterDeployment` YAML Configuration
    ...
    spec:
      template: adopted-cluster-1-8-0
...
child clusters represented by a `ClusterDeployment`. So in order for k0rdent
...
Now you can manage the k0rdent management cluster just as you'd manage 
