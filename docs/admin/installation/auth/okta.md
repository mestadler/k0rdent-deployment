...
This section explains how to configure k0rdent to use Okta as an OIDC provider for authentication. While the examples use k0s for demonstration purposes, the concepts and procedures are fully applicable to any Kubernetes environment that meets the minimum requirements for k0rdent.
...
- **k0rdent Management Cluster:** Although k0s is used in this guide, you may use any [k0rdent management cluster](../create-mgmt-clusters/index.md) (for example, [Minikube](https://minikube.sigs.k8s.io/docs/start/), [MicroK8s](https://microk8s.io/), or a cloud-based cluster) that supports deploying k0rdent.
