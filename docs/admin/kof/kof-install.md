...
* A k0rdent management cluster - You can get instructions to create one in the [quickstart guide](../../quickstarts/quickstart-1-mgmt-node-and-cluster.md).
...
look through the default values of the [kof](https://github.com/k0rdent/kof/blob/v1.8.0/charts/kof/README.md) chart,
...
5. Check the high-level [default values](https://github.com/k0rdent/kof/blob/v1.8.0/charts/kof/values.yaml)
    of the `kof` umbrella chart, and more detailed default values of other [charts](https://github.com/k0rdent/kof/tree/v1.8.0/charts),
    ...
    ??? note "To customize collectors for all child clusters at once now:"
        ...
        and the second `collectors` key is part of its [values](https://github.com/k0rdent/kof/blob/v1.8.0/charts/kof-collectors/values.yaml).

        Check the [examples of OpenTelemetry collectors custom configuration](https://github.com/k0rdent/kof/blob/v1.8.0/docs/collectors.md#example).
...
7. The `aws-standalone-cp` template provides the [default storage class](https://kubernetes.io/docs/concepts/storage/storage-classes/#default-storageclass)
    `ebs-csi-default-sc` for AWS. The [k0rdent quickstart guide](../../quickstarts/quickstart-2-azure.md)
...
8. The `kof-operator` creates and configures `PromxyServerGroup` and `GrafanaDatasource` (if [enabled](kof-grafana.md)) [automatically](https://github.com/k0rdent/kof/blob/v1.8.0/kof-operator/internal/controller/clusterdeployment_kof_cluster_role.go).
...
10. `MultiClusterService` named [kof-regional-cluster](https://github.com/k0rdent/kof/blob/v1.8.0/charts/kof-regional/templates/regional-multi-cluster-service.yaml) configure and install `cert-manager`, `ingress-nginx`, `kof-operators`, `kof-storage`, and `kof-collectors` charts automatically.

    To pass any custom [values](https://github.com/k0rdent/kof/blob/v1.8.0/charts/kof-storage/values.yaml)
...
6. The `kof-operator` [discovers](https://github.com/k0rdent/kof/blob/v1.8.0/kof-operator/internal/controller/clusterdeployment_kof_cluster_role.go)
...
7. `MultiClusterService` named [kof-child-cluster](https://github.com/k0rdent/kof/blob/v1.8.0/charts/kof-child/templates/child-multi-cluster-service.yaml)
    configures and installs `cert-manager`, `kof-operators`, and `kof-collectors` charts automatically.

    To pass any custom [values](https://github.com/k0rdent/kof/blob/v1.8.0/charts/kof-collectors/values.yaml)
