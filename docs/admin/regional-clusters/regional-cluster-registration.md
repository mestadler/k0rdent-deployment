...
To register an existing Kubernetes cluster as a regional cluster in k0rdent, you must create
...
Cert Manager). This field is optional; if unspecified, k0rdent will apply the defaults.
