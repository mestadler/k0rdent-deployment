...
hide:
  ...
  - toc
  - feedback
intent: inspect-k0rdent-api-spec
audience: platform-engineers
prereqs: built-docs-site-and-browser-access
inputs: api-operation-or-resource-to-inspect
outputs: interactive-openapi-reference
related_docs: ../reference/crds/index.md, ../openapi/k0rdent-api-1.6.0.json
...
<script>
  (function () {
    var specUrl = new URL("../openapi/k0rdent-api-1.6.0.json", window.location.href).href;
